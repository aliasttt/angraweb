...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        projects_data = [
            ...
            {
                'title': 'QRMenu Pro - QR Menü ve Online Sipariş',
                'title_en': 'QRMenu Pro - QR Menu & Online Ordering',
                'title_fa': 'QRMenu Pro - منوی QR و سفارش آنلاین',
                'title_ar': 'QRMenu Pro - قائمة QR والطلب عبر الإنترنت',
                'slug': 'qrmenu-pro-preismenu',
                'project_type': 'platform',
                'description': 'Restoran ve kafeler için QR menü, online sipariş ve teslimat platformu. Mobil uygulama, canlı menü senkronizasyonu, çok dilli menü (Türkçe/İngilizce), kampanya motoru ve anlık analitik. Siteden menüden sipariş verilebiliyor.',
                'description_en': 'QR menu, online ordering and delivery platform for restaurants and cafes. Mobile app, live menu sync, multilingual menus (Turkish/English), campaign engine and real-time analytics. Order directly from the restaurant menu on the site.',
                'description_fa': 'پلتفرم منوی QR، سفارش آنلاین و تحویل برای رستوران‌ها و کافه‌ها. اپ موبایل، همگام‌سازی زنده منو، منوی چندزبانه (ترکی/انگلیسی)، موتور کمپین و آنالیتیک لحظه‌ای. سفارش از روی منو در سایت.',
                'description_ar': 'منصة قائمة QR والطلب عبر الإنترنت والتوصيل للمطاعم والمقاهي. تطبيق جوال، مزامنة القائمة المباشرة، قوائم متعددة اللغات (التركية/الإنجليزية)، محرك الحملات والتحليلات الفورية. الطلب من القائمة على الموقع.',
                'domain': 'preismenu.de',
                'url': 'https://preismenu.de/',
                'technologies': 'Django, Python, Mobile App, Online Ordering, Delivery, Multi-language, Turkish, English',
                'featured': True,
                'order': 9,
                'active': True,
            },
            {
                'title': 'Revolift Asansör - Asansör Çözümleri',
                'title_en': 'Revolift Elevator - Elevator Solutions',
                'title_fa': 'Revolift Asansör - راه‌حل‌های آسانسور',
                'title_ar': 'Revolift Asansör - حلول المصاعد',
                'slug': 'revolift-asansor-elevator-solutions',
                'project_type': 'web',
                'description': 'Modern ve lüks asansör çözümleri. Bina içi asansörler, yük asansörleri, bakım ve 7/24 servis hizmeti. 25 yıllık deneyim, referans projeler ve müşteri yorumları.',
                'description_en': 'Modern and luxury elevator solutions. Passenger elevators, freight elevators, maintenance and 24/7 service. 25 years of experience, reference projects and customer testimonials.',
                'description_fa': 'راه‌حل‌های آسانسور مدرن و لوکس. آسانسورهای مسافری و باری، نگهداری و خدمات ۲۴/۷. ۲۵ سال تجربه، پروژه‌های مرجع و نظرات مشتریان.',
                'description_ar': 'حلول مصاعد حديثة وفاخرة. مصاعد ركاب وشحن، صيانة وخدمة 24/7. 25 عاماً من الخبرة ومشاريع مرجعية وشهادات العملاء.',
                'domain': 'aliasadi.online',
                'url': 'https://aliasadi.online/',
                'technologies': 'Django, Python, Web, SEO, Responsive',
                'featured': True,
                'order': 10,
                'active': True,
            },
