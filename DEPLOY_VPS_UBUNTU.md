...
python manage.py generate_seo_content --language=tr --service=ui-ux-design --page-type=cluster --slug=prototype-tasarimi --force
...
python manage.py generate_seo_content --language=en --service=ui-ux-design --page-type=cluster --slug=prototype-design --force
"
